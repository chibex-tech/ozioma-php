...
class Request
{
    ...
    public function __construct(\Chibex\Ozioma $oziomaObj = null)
    {
        $this->response = new Response();
        $this->response->setRequestObject($this);
        $this->oziomaObj = $oziomaObj;
        $this->response->forApi = !is_null($oziomaObj);
    ...
    {
        if (isset($this->oziomaObj) && !$this->oziomaObj->use_guzzle) {
    ...
    {
        if (!Ozioma::$fallback_to_file_get_contents) {
            return;
        }
